...
```{r Load Structural diversity functions, echo=FALSE}
#Load functions
...
```{r Calculate structural diversity, out.width= '50%',results='hide'}
...
#2. Sky view factor indices#
```{r Load SkyView functions, echo=FALSE}
#Load functions
...
#3. Common indices
```{r Load common indices functions, echo=FALSE}
#Load functions
...
```{r Load Neighbors distance functions, echo=FALSE}
#Load functions
...
```{r Load topographic position indices functions, echo = FALSE}
#Load functions
...
```{r Load FreeSpace functions, echo=FALSE}
#Load functions
...
```{r Load EarthMovers functions, echo=FALSE}
#Load functions
